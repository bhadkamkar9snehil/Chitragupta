# XStudio_Xbatch.dbo.RM_Reheating_Furnace_Block

**table_kind:** production_data

### What this table is for

- **Inferred from its own column names** (not human-verified): columns repeatedly reference time, end, equipment, preheating, set, start, temp, top, zone.
