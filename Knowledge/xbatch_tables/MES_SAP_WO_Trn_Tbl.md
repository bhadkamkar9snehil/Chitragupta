# XStudio_Xbatch.dbo.MES_SAP_WO_Trn_Tbl
...
- **Indexed under investigation keywords:** core, errors, execution, integration, order, posting, routing, sap, work (source: `Knowledge/table_keyword_index.json`, human-curated)
