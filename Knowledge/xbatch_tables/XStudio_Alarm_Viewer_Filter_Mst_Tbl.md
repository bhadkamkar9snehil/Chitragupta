# XStudio_Xbatch.dbo.XStudio_Alarm_Viewer_Filter_Mst_Tbl

**table_kind:** production_data

### What this table is for

- **Inferred from its own column names** (not human-verified): columns repeatedly reference time, alarm, name, tag, type, acknowledge, area, description, event, message, received, remark.
