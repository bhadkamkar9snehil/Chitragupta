---
type: procedure
title: "XMES_Get_Billet_Count_USP"
built: "2026-09-24T11:36:36"
---

# XMES_Get_Billet_Count_USP

Parameters: @WorkOrderID varchar, @Batch varchar, @Type tinyint, @IsExt bit.

## Reads

- Grade_Master: GradeName, ID, IsDeleted
- RM_Operator_HeatSelection: Batch, BilletMaterialType, BilletQty, Heatno, IsDeleted, Status
