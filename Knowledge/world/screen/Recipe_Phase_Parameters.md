...
XStudio screen 'Recipe Phase Parameters' (Recipe Phase Parameter; page List_Page_XBatch_Recipe_Phase_Parameter_Mst_Tbl, list view List_XBatch_Recipe_Phase_Parameter_Mst_Tbl).
