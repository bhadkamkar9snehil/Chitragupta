...
XStudio screen 'Recipe Phase Groups' (Recipe Phase Group; page List_Page_XBatch_Recipe_Phase_Group_Mst_Tbl, list view List_XBatch_Recipe_Phase_Group_Mst_Tbl).
