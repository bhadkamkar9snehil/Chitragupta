...
XStudio screen 'Inventory_Xbatch_Material_Inventory_Trn_Tbl' (Xbatch Material Inventory; page List_Page_Xbatch_Material_Inventory_Trn_Tbl, list view List_Xbatch_Material_Inventory_Trn_Tbl).
